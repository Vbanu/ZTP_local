...
#$store = Read-Host "Enter the 4 Digit Store number"
...
"`n"
Write-Host "If All 2 ILOs reachable than please go ahead for Verifying VMNIC ports" -BackgroundColor Yellow -ForegroundColor Black
"`n"
...
$HostExtra = "show int br | i 1000 | include 1/1/15"
...
#$Result2.output
#"`n"
#Write-Host "If All 2 ILOs reachable and VMNICs are good Than please go ahead" -BackgroundColor Red 
